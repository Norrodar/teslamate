defmodule TeslaMate.Import.TeslaLogger.ValidatorTest do
    ...
    test "accepts valid positions" do
      positions = [
        %{
          ...
          latitude: Decimal.new(52),
          longitude: Decimal.new(13),
          battery_level: 72,
          speed: 65,
          odometer: 42000.0
        },
    ...
    test "accepts valid drives" do
      drives = [
        %{
          ...
          end_date: ~U[2023-06-15 12:30:00Z],
          speed_max: 130
        },
        %{
          start_date: ~U[2023-06-15 14:00:00Z],
          end_date: ~U[2023-06-15 14:45:00Z],
          speed_max: 100
        }
      ]
    ...
    test "warns about negative charge_energy_added" do
      charges = [
        %{
          date: ~U[2023-06-15 20:00:00Z],
          battery_level: 45,
          charge_energy_added: Decimal.new(-5),
          charger_power: 11,
          charger_phases: 1
        }
      ]
  ...
  describe "validate_charging_processes/1" do
    test "accepts valid processes" do
      processes = [
        %{
          start_date: ~U[2023-06-15 20:00:00Z],
          end_date: ~U[2023-06-15 23:00:00Z],
          charge_energy_added: Decimal.new(45)
        }
      ]

      {valid, _errors} = Validator.validate_charging_processes(processes)
      assert length(valid) == 1
    end
    ...
    test "warns about overlapping processes" do
      processes = [
        ...
        %{
          start_date: ~U[2023-06-15 22:00:00Z],
          end_date: ~U[2023-06-16 01:00:00Z],
    ...
    test "formats warning errors as strings" do
      errors = [
        %ValidationError{
          ...
          row_id: 5,
          field: :battery_level,
          message: "value 105 outside range [0, 100]",
          severity: :warning
        },
        %ValidationError{
          table: "positions",
